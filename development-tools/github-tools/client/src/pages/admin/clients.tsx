...
export default function ClientsPage() {
  ...
  const { data, isLoading, error, refetch, isFetching } = useQuery({
    queryKey: ["/api/admin/clients", page],
    queryFn: async () => {
      try {
        console.log('Fetching clients with credentials, page:', page);
        const response = await fetch(`/api/admin/clients?page=${page}&limit=${PAGE_SIZE}`, {
          credentials: 'include',
          headers: {
