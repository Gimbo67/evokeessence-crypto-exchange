    ...
    <div className="min-h-screen flex flex-col bg-background w-full">
      ...
      <main className="flex-1 pt-24 pb-16 w-full">
        <Container className="w-full">
          <div className="max-w-2xl mx-auto text-center mb-12 w-full">
              ...
              <CardContent className="pt-6">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-medium">{t('office_address')}</p>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">support@evo-exchange.com</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <Clock className="h-5 w-5 text-primary" />
                    <div>
                      <p className="font-medium">{t('business_hours')}</p>
                      <p className="text-muted-foreground">Mon - Fri: 9:00 - 17:00 CET</p>
                    </div>
                  </div>
                </div>
              </CardContent>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Textarea {...field} placeholder={t('message_placeholder')} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
