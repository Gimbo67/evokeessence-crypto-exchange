...
export const users = pgTable("users", {
  ...
  sumsub_review_status: text("sumsub_review_status"), // pending, queued, completed, onHold
  sumsub_review_result: text("sumsub_review_result"), // RED, GREEN, YELLOW
...
export const telegramGroups = pgTable("telegram_groups", {
  ...
  created_at: timestamp("created_at").defaultNow(),
  updated_at: timestamp("updated_at").defaultNow(),
  metadata: jsonb("metadata") // Store additional group info
});
...
export const telegramNotifications = pgTable("telegram_notifications", {
  ...
  notification_type: text("notification_type").notNull(), // registration, kyc_status, transaction
...
// Relations for Telegram tables
export const telegramGroupsRelations = relations(telegramGroups, ({ many }) => ({
  notifications: many(telegramNotifications)
}));

export const telegramNotificationsRelations = relations(telegramNotifications, ({ one }) => ({
...
export const selectTelegramGroupSchema = createSelectSchema(telegramGroups);
export const insertTelegramNotificationSchema = createInsertSchema(telegramNotifications);
export const selectTelegramNotificationSchema = createSelectSchema(telegramNotifications);

// Export types
export type InsertTelegramGroup = typeof telegramGroups.$inferInsert;
export type SelectTelegramGroup = typeof telegramGroups.$inferSelect;
export type InsertTelegramNotification = typeof telegramNotifications.$inferInsert;
export type SelectTelegramNotification = typeof telegramNotifications.$inferSelect;