...
/**
 * Direct webhook setup endpoint that bypasses static routing issues
 */
router.get('/api/setup-webhook-direct', (req: Request, res: Response) => {
  const html = `
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <script>
        async function enableWebhook() {
            ...
            try {
                console.log('Setting webhook to enable 24/7 operation...');
                ...
                result.innerHTML = \`
                    ...
                    <div style="margin-top: 15px; padding: 15px; background: #fef3c7; border-radius: 6px;">
                        ...
                        <ul style="margin: 10px 0; padding-left: 20px;">
                            <li>Ensure bot token is valid and webhook endpoint is accessible</li>
