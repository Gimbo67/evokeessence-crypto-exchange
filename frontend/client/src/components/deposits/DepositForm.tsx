...
export function DepositForm({ onStepChange, user, createDeposit: externalCreateDeposit, className }: DepositFormProps) {
  ...
  const confirmDeposit = () => {
    ...
    progressInterval = setInterval(() => {
      setProgress(prev => {
        if (prev >= 90) {
          // Don't clear interval here, let success/error handlers do it
          return 90; // Cap at 90% until we get response
        }
        return prev + 10;
      });
      ...
      onError: (error: any) => {
        ...
        if (isAuthError) {
          toast({
            ...
            description: t("please_login_to_create_deposit"),
            duration: 10000,
          });
        } else {
          toast({
        ...
        {showConfirmation ? (
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-medium">EvokeEssence s.r.o.</span>
                      <CopyButton
                        text="EvokeEssence s.r.o."
                        label={t("recipient")}
                        toast={toast}
                      />
                    </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-medium font-mono select-all">LT80 3130 0101 4308 4139</span>
                      <CopyButton
                        text="LT80 3130 0101 4308 4139"
                        label="IBAN"
                        toast={toast}
                      />
                    </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-medium font-mono select-all">BZENLT22</span>
                      <CopyButton
                        text="BZENLT22"
                        label="BIC"
                        toast={toast}
          ...
          <Form {...form}>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              {/* Currency is fixed to EUR - no selection needed */}
              <div className="text-sm text-muted-foreground">
                <p>{t("currency")}: EUR (Euro)</p>
                <p className="text-xs">{CURRENCY_PROCESSING.EUR.note} • {t("est_completion")}: {getEstimatedCompletionDate('EUR')}</p>
              </div>
