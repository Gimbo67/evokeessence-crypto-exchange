...
import telegramTestRoutes from './telegram-test.routes';
import telegramBotRouter from './telegram-bot.routes';
import telegramWebhookRouter from './telegram-webhook.routes';
import webhookSetupRouter from './webhook-setup.routes';
import directWebhookSetupRouter from './direct-webhook-setup.routes';

export function registerRoutes(app: Express): Server {
  console.log('Starting route registration...');

  try {
    // Register Telegram webhook routes FIRST - highest priority before any middleware
    console.log('[Server] Registering Telegram webhook routes (PRIORITY)...');
    app.use('/api', telegramWebhookRouter);
    console.log('[Server] Telegram webhook routes registered with highest priority');
    ...
    // Register KYC routes (including webhooks) - MUST be before static files
    console.log('[Server] Registering KYC routes...');
    app.use(kycRouter);
    ...
    console.log('[Server] Registering Telegram test routes...');
    app.use(telegramTestRoutes);
    console.log('[Server] Telegram test routes registered successfully');

    // Register Telegram bot routes
    console.log('[Server] Registering Telegram bot routes...');
    app.use('/api/telegram', telegramBotRouter);
    console.log('[Server] Telegram bot routes registered successfully');

    // Telegram webhook routes already registered at top priority

    // Register direct webhook setup route (alternative path)
    console.log('[Server] Registering direct webhook setup route...');
    app.use('/', directWebhookSetupRouter);
    console.log('[Server] Direct webhook setup route registered successfully');

    // Register webhook setup page
    console.log('[Server] Registering webhook setup routes...');
    app.use('/', webhookSetupRouter);
    console.log('[Server] Webhook setup routes registered successfully');
