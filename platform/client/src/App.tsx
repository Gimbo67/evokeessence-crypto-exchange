...
const KycManagement = React.lazy(() => import("@/components/admin/KycManagement"));
const BlockedUsers = React.lazy(() => import("@/pages/admin/blocked-users"));
const AdminExport = React.lazy(() => import("@/pages/admin/Export"));
