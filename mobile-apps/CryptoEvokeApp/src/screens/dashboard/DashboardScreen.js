...
import { marketApi } from '../../api/apiClient';
          ...
          <>
            ...
            <View style={styles.balanceCard}>
              ...
              <View style={styles.balanceRow}>
                ...
                <Text style={styles.balanceValue}>
                  {formatCurrency(user?.balance || '0', user?.balanceCurrency || user?.balance_currency || 'USD')}
                </Text>
              </View>
              <View style={styles.kycStatusContainer}>
                ...
                <Text style={[
                  ...
                  {(user?.kycStatus || user?.kyc_status || 'not_started').replace('_', ' ').toUpperCase()}
                </Text>
              </View>
              ...
              {!isVerified && (
                    ...
                    Alert.alert(
                      ...
                      [
                        ...
                        { 
                          ...
                          onPress: async () => {
                            try {
                              Alert.alert('Verification Process', 'You will be redirected to our verification portal to complete your KYC process.');
                            } catch (error) {
                ...
                >
                  <Text style={styles.verifyButtonText}>
                    {(user?.kycStatus === 'not_started' || user?.kyc_status === 'not_started') ? 'Start Verification' : 'Complete Verification'}
                  </Text>
                </TouchableOpacity>
              )}
            </View>
            ...
            <View style={styles.actionsContainer}>
              <TouchableOpacity 
                ...
                onPress={() => navigation.navigate('Markets')}
              >
                <Ionicons name="stats-chart-outline" size={24} color="#6200ee" />
                <Text style={styles.actionText}>Markets</Text>
              </TouchableOpacity>
              
              {/* Transak Integration Button */}
              <TouchableOpacity 
                style={styles.actionButton}
