...
import { User, Upload, CreditCard, History, Shield, Loader2, Home, Book, Users, HelpCircle, AlertCircle, RefreshCw, DollarSign } from "lucide-react";
import { useTranslations } from "@/lib/language-context";
import { useLanguage } from "@/lib/language-context";
import { LanguageSelector } from "@/components/language-selector";
import type { User as UserType } from "@/hooks/use-user";
import ProfileTab from "./tabs/ProfileTab";
import { TransakTab } from "./tabs/TransakTab";
            ...
            >
              ...
              >
                {[
                  ...
                  { id: 'transak', icon: DollarSign, label: t('buy_crypto') },
                ...
                {isLoading ? (
                  ...
                  >
                    <Suspense fallback={<LoadingSpinner />}>
                      {/* Tab Content */}
                      {['profile', 'transak', 'deposit', 'usdc', 'history', 'security'].map(id => (
                        <TabsContent
                          key={id}
                          value={id}
                          role="tabpanel"
                        ...
                        >
                          ...
                          {id === 'transak' && <TransakTab user={user} />}
